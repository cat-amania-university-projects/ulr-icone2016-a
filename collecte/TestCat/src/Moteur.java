...
abstract class Moteur {
  ...
  protected HashMap<Lien, ArrayList<String>> map;
  protected ArrayList<Lien> linklist;
  ...
  protected String title;
    ...
    public ArrayList<Lien> getLinklist() {
        return linklist;
    }

    public void setLinklist(ArrayList<Lien> linklist) {
